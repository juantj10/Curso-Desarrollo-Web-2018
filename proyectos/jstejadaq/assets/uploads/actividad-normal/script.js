...
window.onload = function() {
    var posOp = Math.floor(Math.random() * _operaciones.length);/* Seleciona una operacion al azar para ejecutar cuando se cargue la pantalla */
    determinarResultado(_operaciones[posOp].nombre);/* Se determina e resultado de la operacion */
